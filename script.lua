...
local keyboardIdentifier = '19AD2E6D'
...
sendToAHK = function (key)
      ...
      local file = io.open("C:\\Users\\Bard\\Google Drive\\2nd-Keyboard-Macroing\\2nd-Keyboard-LuaMacros-Working\\keypressed.txt", "w") -- writing this string to a text file on disk is probably NOT the best method. Feel free to program something better!
